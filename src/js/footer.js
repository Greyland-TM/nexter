...
const Footer = () => (
    <footer className="footer">
        <ul className="nav">
            ...
            <li className="nav__item"><a href="#" className="nav__link">Downloaad home planner</a></li>
        ...
        <p className="copyright">&copy; Copyright 2017 by Jonas Schmedtmann. Feel free to use this project for your 
            own purposes. This does not apply if you plan to produce your own cours or tuttorials based on this project.
        </p>
    </footer>
);
